    ...
    SecurityFilterChain securityFilterChain(final HttpSecurity http) throws Exception {
        http.csrf(CsrfConfigurer::disable)
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/furniture/add/**","/email/send","/category/add/**", "/furniture/list", "/category/list","/furniture/user/busket","/furniture/**", "/furniture/update/{productId}", "/furniture/buy/{productId}", "/review/add/{productId}/**","/checkout", "/furniture/myproducts", "/furniture/information/add/**").permitAll()
